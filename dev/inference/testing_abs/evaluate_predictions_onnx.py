...
class PredictionEvaluator:
    ...
    def plot_results(self, results: Dict, save_path: str = None):
        ...
        fig.suptitle(
            "ONNX+TensorRT Prediction vs Ground Truth (DDIM 16 steps)", fontsize=16
        )
...
def main():
    ...
    parser.add_argument(
        "--rosbag", type=str, required=True, help="Path to rosbag for evaluation"
    )
    parser.add_argument(
        "--num-samples", type=int, default=300, help="Number of samples to evaluate"
    )
    parser.add_argument(
